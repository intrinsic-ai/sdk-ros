#ifndef UTIL_THREAD_STOP_TOKEN_H_
#define UTIL_THREAD_STOP_TOKEN_H_
...
class StopToken {
 public:
  ...
  INTR_MUST_USE_RESULT bool stop_requested() const noexcept {
    return stop_state_ != nullptr && stop_state_->stopped;
  }

  INTR_MUST_USE_RESULT bool stop_possible() const noexcept {
...
#endif  // UTIL_THREAD_STOP_TOKEN_H_
