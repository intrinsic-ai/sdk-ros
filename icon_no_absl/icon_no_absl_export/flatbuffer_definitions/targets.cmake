...
add_library(icon_shared_memory_external_fbs_cc INTERFACE)
target_include_directories(icon_shared_memory_external_fbs_cc INTERFACE
  "$<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}>"
  "$<INSTALL_INTERFACE:include>"
)
...
target_link_libraries(icon_shared_memory_external_fbs_cc INTERFACE
  flatbuffers::flatbuffers
)
install(TARGETS icon_shared_memory_external_fbs_cc EXPORT icon_shared_memoryTargets)