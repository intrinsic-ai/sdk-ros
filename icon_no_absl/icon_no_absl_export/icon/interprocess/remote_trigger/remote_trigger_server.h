#ifndef ICON_INTERPROCESS_REMOTE_TRIGGER_REMOTE_TRIGGER_SERVER_H_
#define ICON_INTERPROCESS_REMOTE_TRIGGER_REMOTE_TRIGGER_SERVER_H_
...
class RemoteTriggerServer {
 public:
  ...
  void Start(
      const log::Logger* logger INTR_ATTRIBUTE_LIFETIME_CAPTURE_BY(this));
  ...
  // start correctly.
  Status StartAsync(const log::Logger* logger
                        INTR_ATTRIBUTE_LIFETIME_CAPTURE_BY(this),
 ...
 private:
  ...
  void Run(const log::Logger* logger INTR_ATTRIBUTE_LIFETIME_CAPTURE_BY(this),
           Prelude prelude = nullptr);
...
#endif  // ICON_INTERPROCESS_REMOTE_TRIGGER_REMOTE_TRIGGER_SERVER_H_
