#ifndef ICON_INTERPROCESS_BINARY_FUTEX_H_
#define ICON_INTERPROCESS_BINARY_FUTEX_H_
...
//  if(auto status = shm_manager.AddSegment(request_id, BinaryFutex());
//  !status.ok()) {
//    return status;
//  }
//  if(auto status = shm_manager.AddSegment(response_id, BinaryFutex());
//  !status.ok()) {
//    return status;
//  }
//
...
#endif  // ICON_INTERPROCESS_BINARY_FUTEX_H_
