#ifndef ICON_INTERPROCESS_SHARED_MEMORY_MANAGER_MEMORY_SEGMENT_H_
#define ICON_INTERPROCESS_SHARED_MEMORY_MANAGER_MEMORY_SEGMENT_H_
...
template <class T>
Status SharedMemorySegmentFitsLowerSizeBound(std::string_view segment_name,
                                             size_t segment_size) {
...
#endif  // ICON_INTERPROCESS_SHARED_MEMORY_MANAGER_MEMORY_SEGMENT_H_
