#ifndef ICON_INTERPROCESS_SHARED_MEMORY_MANAGER_DOMAIN_SOCKET_UTILS_H_
#define ICON_INTERPROCESS_SHARED_MEMORY_MANAGER_DOMAIN_SOCKET_UTILS_H_
...
#endif  // ICON_INTERPROCESS_SHARED_MEMORY_MANAGER_DOMAIN_SOCKET_UTILS_H_
