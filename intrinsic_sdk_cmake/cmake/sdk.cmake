...
list(FILTER intrinsic_SRCS EXCLUDE REGEX "/intrinsic/scene/")
list(FILTER intrinsic_SRCS EXCLUDE REGEX "/incode/")
list(FILTER intrinsic_SRCS EXCLUDE REGEX "/intrinsic/marshal/")
list(FILTER intrinsic_SRCS EXCLUDE REGEX "/intrinsic/util/object_store/")
list(FILTER intrinsic_SRCS EXCLUDE REGEX "/intrinsic/geometry/")
...
list(FILTER intrinsic_SRCS EXCLUDE REGEX "/intrinsic/world/")
...
install(
  DIRECTORY "${intrinsic_sdk_SOURCE_DIR}/incode"
  DESTINATION "include/${PROJECT_NAME}"
  FILES_MATCHING
  PATTERN "*.h"
)
